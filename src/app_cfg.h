 ...
 * 48 MHz - 3.05
 */
#define CLOCK_SYS_CLOCK_HZ  		24000000 // 16, 24, 48 MHz
...
#define ZB_DEFAULT_TX_POWER_IDX					RF_POWER_P1p99dBm	// TX 8 mA
#define	BLE_DEFAULT_TX_POWER_IDX				RF_POWER_P1p99dBm	// TX 8 mA

#elif USE_BATTERY == BATTERY_CR2430

#define ZB_DEFAULT_TX_POWER_IDX					RF_POWER_INDEX_P2p39dBm
#define	BLE_DEFAULT_TX_POWER_IDX				RF_POWER_INDEX_P2p39dBm

#elif USE_BATTERY == BATTERY_CR2450

#define ZB_DEFAULT_TX_POWER_IDX					RF_POWER_INDEX_P2p61dBm
#define	BLE_DEFAULT_TX_POWER_IDX				RF_POWER_INDEX_P2p61dBm
...
/* Configure startup */
#define STARTUP_IN_BLE				1	// always =1 !
...
#define ZCL_TEMPERATURE_MEASUREMENT_SUPPORT			(DEV_SERVICES & SERVICE_THS)
#define ZCL_RELATIVE_HUMIDITY_SUPPORT   			(DEV_SERVICES & SERVICE_THS)
#define ZCL_THERMOSTAT_UI_CFG_SUPPORT				1 	// Configure: DISPLAY: on/off, C/F, smiley & SENSOR: offset, time
#define ZCL_POLL_CTRL_SUPPORT						1
#define ZCL_GROUP_SUPPORT							0
#define ZCL_OTA_SUPPORT								1
#define REJOIN_FAILURE_TIMER						1	// not change!
...
#define DEFAULT_POLL_RATE			(g_zcl_thermostatUICfgAttrs.measure_interval * (4 * POLL_RATE_QUARTERSECONDS)) //  msecond
//#define READ_SENSOR_TIMER_MS 		DEFAULT_POLL_RATE //  msecond
