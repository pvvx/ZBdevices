...
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=TH03 POJECT_DEF="-DBOARD=BOARD_TH03Z"
@if not exist "bin\TH03%SWVER%.bin" goto :error
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=ZTH01 POJECT_DEF="-DBOARD=BOARD_ZTH01"
@if not exist "bin\ZTH01%SWVER%.bin" goto :error
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=ZTH02 POJECT_DEF="-DBOARD=BOARD_ZTH02"
@if not exist "bin\ZTH02%SWVER%.bin" goto :error
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=ZTH03 POJECT_DEF="-DBOARD=BOARD_ZTH03"
@if not exist "bin\ZTH03%SWVER%.bin" goto :error
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=LKTMZL02 POJECT_DEF="-DBOARD=BOARD_LKTMZL02"
@if not exist "bin\LKTMZL02%SWVER%.bin" goto :error
make -s -j clean
...
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=ZG227 POJECT_DEF="-DBOARD=BOARD_ZG_227Z"
@if not exist "bin\ZG227%SWVER%.bin" goto :error
python3 make\zb_bin_ota.py bin\ZTS0201Z3000%SWVER%.bin bin\TS0201z%SWVER% -m0x1141 -i0xd3a3 -v0x01983001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\ZTH01%SWVER%.bin bin\ZTH01_t2zb%SWVER% -m0x1141 -i0xd3a3 -v0x01993001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\ZTH02%SWVER%.bin bin\ZTH02_t2zb%SWVER% -m0x1141 -i0xd3a3 -v0x01993001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\ZTH03%SWVER%.bin bin\ZTH03_t2zb%SWVER% -m0x1141 -i0xd3a3 -v0x01993001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\TH03%SWVER%.bin bin\TH03_s2zb%SWVER% -m0x1286 -i0x0202 -v0x10993607 -s"Sonoff to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\LKTMZL02%SWVER%.bin bin\LKTMZL02_t2zb%SWVER% -m0x1141 -i0xd3a3 -v0x01993001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\ZYZTH02%SWVER%.bin bin\ZYZTH02_t2zb%SWVER% -m0x1002 -i0xd3a3 -v0x66993001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\ZG227%SWVER%.bin bin\ZG227_t2zb%SWVER% -m0x1286 -i0x0203 -v0x10983001 -s"Tuya to ZigbeeTlc"
@exit
:error
echo "Error!"
